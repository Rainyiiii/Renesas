...
sci_b_uart_instance_ctrl_t g_weight_uart_ctrl;

sci_b_baud_setting_t g_weight_uart_baud_setting =
        {
...
const sci_b_uart_extended_cfg_t g_weight_uart_cfg_extend =
{ .clock = SCI_B_UART_CLOCK_INT, .rx_edge_start = SCI_B_UART_START_BIT_FALLING_EDGE, .noise_cancel =
  ...
  .rx_fifo_trigger = SCI_B_UART_RX_FIFO_TRIGGER_MAX, .p_baud_setting = &g_weight_uart_baud_setting, .flow_control =
...
const uart_cfg_t g_weight_uart_cfg =
{ .channel = 4, .data_bits = UART_DATA_BITS_8, .parity = UART_PARITY_OFF, .stop_bits = UART_STOP_BITS_1, .p_callback =
          weight_uart_callback,
  .p_context = NULL, .p_extend = &g_weight_uart_cfg_extend,
...
const uart_instance_t g_weight_uart =
{ .p_ctrl = &g_weight_uart_ctrl, .p_cfg = &g_weight_uart_cfg, .p_api = &g_uart_on_sci_b };
...
{ .channel = 1, .rate = I2C_MASTER_RATE_STANDARD, .slave = 0x38, .addr_mode = I2C_MASTER_ADDR_MODE_7BIT,
#define RA_NOT_DEFINED (1)
#if (RA_NOT_DEFINED == RA_NOT_DEFINED)
  .p_transfer_tx = NULL,
#else
...
#endif
#undef RA_NOT_DEFINED
  .p_callback = ft6336_i2c_callback,
  .p_context = NULL,
...
/* Actual period: 4e-8 seconds. Actual duty: 50%. */.period_counts = (uint32_t) 0xa,
  .duty_cycle_counts = 0x5, .source_div = (timer_source_div_t) 0, .channel = 0, .p_callback = NULL,
...
{ .transfer_settings_word_b.dest_addr_mode = TRANSFER_ADDR_MODE_FIXED,
  ...
  .num_blocks = 0,
  .length = 128, };
const dmac_extended_cfg_t g_sdmmc0_transfer_extend =
...
{ .p_info = &g_sdmmc0_transfer_info, .p_extend = &g_sdmmc0_transfer_extend, };
/* Instance structure to use this module. */
const transfer_instance_t g_sdmmc0_transfer =
{ .p_ctrl = &g_sdmmc0_transfer_ctrl, .p_cfg = &g_sdmmc0_transfer_cfg, .p_api = &g_transfer_on_dmac };
#define RA_NOT_DEFINED (UINT32_MAX)
#if (RA_NOT_DEFINED) != (1)
...
{ .bus_width = SDMMC_BUS_WIDTH_1_BIT,
  .channel = 0,
  .p_callback = dataset_storage_sdhi_callback,
  .p_context = NULL,
  .block_size = 512,
  ...
  .p_extend = NULL,
  .p_lower_lvl_transfer = &g_sdmmc0_transfer,

...
__attribute__((aligned(16))) uint8_t sub_0003_arena[82944];
// Fast scratch arena not used for Ethos-U55
//  We will not create it for now and reuse the address of the other arena
// __attribute__((aligned(16))) static uint8_t sub_0003_fast_scratch[82944];
...
int sub_0003_invoke(bool clean_outputs) {
  ...
  // Buffer sub_0003_model with size 68544 and address: 4294967295
  base_addrs[0] = (uint64_t)(uintptr_t)sub_0003_model_data;
  base_addrs_size[0] = sub_0003_model_data_size;
  // Buffer sub_0003_arena with size 82944 and address: 0
  base_addrs[1] = (uint64_t)(uintptr_t) (sub_0003_arena+0);
  base_addrs_size[1] = 82944;

  // Buffer sub_0003_fast_scratch with size 82944 and address: 0
  base_addrs[2] = (uint64_t)(uintptr_t) (sub_0003_arena+0);
  base_addrs_size[2] = 82944;

  // Buffer input_tensor_0 with size 27648 and address: 55296
  base_addrs[3] = (uint64_t)(uintptr_t) (sub_0003_arena+55296);
  base_addrs_size[3] = 27648;

  // Buffer input_tensor_1 with size 13824 and address: 0
  base_addrs[4] = (uint64_t)(uintptr_t) (sub_0003_arena+0);
  base_addrs_size[4] = 13824;

  // Buffer output_tensor_0 with size 1728 and address: 11520
  if (clean_outputs) {
    memset(sub_0003_arena + 11520, 0, 1728);
  }
  base_addrs[5] = (uint64_t)(uintptr_t) (sub_0003_arena+11520);
  base_addrs_size[5] = 1728;

  // Buffer output_tensor_1 with size 432 and address: 13248
  if (clean_outputs) {
    memset(sub_0003_arena + 13248, 0, 432);
  }
  base_addrs[6] = (uint64_t)(uintptr_t) (sub_0003_arena+13248);
  base_addrs_size[6] = 432;

  // Buffer output_tensor_2 with size 576 and address: 0
  if (clean_outputs) {
    memset(sub_0003_arena + 0, 0, 576);
  }
  base_addrs[7] = (uint64_t)(uintptr_t) (sub_0003_arena+0);
  base_addrs_size[7] = 576;

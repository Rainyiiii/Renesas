...
void hal_entry(void)
{
    ...
    for (int n = 0; n < ntimes; n += 1) {
        memcpy(GetModelInputPtr_images(), model_images, model_images_SIZE);
    ...
    // Comparing outputs
    {
        ...
        int misses = CompareOutput(model_reg_s22_70452_70740, GetModelOutputPtr_reg_s22_70452_70740(), model_reg_s22_70452_70740_COUNT, 0.1f);
        if (misses == 0) {
            SEGGER_RTT_WriteString(0, "MATCH\r\n");
        } else {
            SEGGER_RTT_printf(0, "FAILED: %d/%d misses\r\n", misses, model_reg_s22_70452_70740_COUNT);
        }
    }

    {
        SEGGER_RTT_printf(0, "Comparing output 1\r\n");
        int misses = CompareOutput(model_obj_s22_70453_70738, GetModelOutputPtr_obj_s22_70453_70738(), model_obj_s22_70453_70738_COUNT, 0.1f);
        if (misses == 0) {
            SEGGER_RTT_WriteString(0, "MATCH\r\n");
        } else {
            SEGGER_RTT_printf(0, "FAILED: %d/%d misses\r\n", misses, model_obj_s22_70453_70738_COUNT);
        }
    }

    {
        SEGGER_RTT_printf(0, "Comparing output 2\r\n");
        int misses = CompareOutput(model_cls_s22_70454_70736, GetModelOutputPtr_cls_s22_70454_70736(), model_cls_s22_70454_70736_COUNT, 0.1f);
        if (misses == 0) {
            SEGGER_RTT_WriteString(0, "MATCH\r\n");
        } else {
            SEGGER_RTT_printf(0, "FAILED: %d/%d misses\r\n", misses, model_cls_s22_70454_70736_COUNT);
        }
    }

    {
        SEGGER_RTT_printf(0, "Comparing output 3\r\n");
        int misses = CompareOutput(model_reg_s11_70455_70739, GetModelOutputPtr_reg_s11_70455_70739(), model_reg_s11_70455_70739_COUNT, 0.1f);
        if (misses == 0) {
            SEGGER_RTT_WriteString(0, "MATCH\r\n");
        } else {
            SEGGER_RTT_printf(0, "FAILED: %d/%d misses\r\n", misses, model_reg_s11_70455_70739_COUNT);
        }
    }

    {
        SEGGER_RTT_printf(0, "Comparing output 4\r\n");
        int misses = CompareOutput(model_obj_s11_70456_70737, GetModelOutputPtr_obj_s11_70456_70737(), model_obj_s11_70456_70737_COUNT, 0.1f);
        if (misses == 0) {
            SEGGER_RTT_WriteString(0, "MATCH\r\n");
        } else {
            SEGGER_RTT_printf(0, "FAILED: %d/%d misses\r\n", misses, model_obj_s11_70456_70737_COUNT);
        }
    }

    {
        SEGGER_RTT_printf(0, "Comparing output 5\r\n");
        int misses = CompareOutput(model_cls_s11_70457_70735, GetModelOutputPtr_cls_s11_70457_70735(), model_cls_s11_70457_70735_COUNT, 0.1f);
        if (misses == 0) {
            SEGGER_RTT_WriteString(0, "MATCH\r\n");
        } else {
            SEGGER_RTT_printf(0, "FAILED: %d/%d misses\r\n", misses, model_cls_s11_70457_70735_COUNT);
        }
    }
